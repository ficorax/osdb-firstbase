...
static assign_vid(fb_mnode *, fb_mnode *, int);
static assign_field(fb_mnode *, fb_mnode *, int);
static assign_field_via(fb_mnode *, fb_mnode *, int, fb_database *);
 ...
 */
   ...
   static assign_field_via(n1, n2, op, db)
      fb_mnode *n1, *n2;
      int op;
      fb_database *db;
