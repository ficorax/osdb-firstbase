...
extern fb_idx_copy(fb_bidx *bt, fb_bidx *bf);
extern fb_idx_free(fb_bidx *bi);
...
extern fb_seq_copy(fb_bseq *bt, fb_bseq *bf);
extern fb_seq_free(fb_bseq *bs);
