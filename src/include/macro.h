...
extern fb_gcollect_cell(fb_cell *);
...
extern fb_freenode(fb_mnode *);
extern fb_free_globalnode(fb_mnode *);
...
extern m_destroy_call_lists(fb_mnode *);
...
extern eval_field(fb_field *, fb_database *, fb_mnode *);
...
extern int destroy_list(fb_mnode *n);
