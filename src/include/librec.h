...
extern fb_initlock(int ig, fb_database *db);
extern fb_initlog(fb_database *hp);
...
extern fb_putlog(fb_database *hp);
...
extern fb_search_count(fb_database *, long *, long *, char *, int, long);
