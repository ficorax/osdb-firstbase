...
extern fb_e_delete_char_backward();
extern fb_e_delete_char_forward();
extern fb_e_delete_to_beginning_of_line();
extern fb_e_delete_to_end_of_line();
extern fb_e_delete_word_backward();
extern fb_e_delete_word_forward();
extern fb_e_display();
...
extern fb_e_move_end_word_forward();
extern fb_e_move_word_backward();
extern fb_e_move_word_forward();
...
extern fb_e_delete_char_backward(void);
extern fb_e_delete_char_forward(void);
extern fb_e_delete_to_beginning_of_line(void);
extern fb_e_delete_to_end_of_line(void);
extern fb_e_delete_word_backward(void);
extern fb_e_delete_word_forward(void);
...
extern fb_e_move_end_word_forward(void);
extern fb_e_move_word_backward(void);
extern fb_e_move_word_forward(void);
...
extern fb_getco(fb_database *hp);
