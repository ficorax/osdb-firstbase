 ...
 *
 * $Id: sprintf.c,v 9.0 2001/01/09 02:56:30 john Exp $
 *
...
#ifndef LINT
static char Sprintf_sid[] = "@(#) $Id: sprintf.c,v 9.0 2001/01/09 02:56:30 john Exp $";
#endif
...
/*
 * fb_sprintf - sbuf - vararg list of pp
 *	deposit into sbuf the proper printf manner of arguments.
 *	this version is machine independent, using varargs.
 */

   void fb_sprintf(sbuf, pp)
      char *sbuf;
      va_list *pp;

      {
         register char *c;
         char *format, *mf, buf[FB_MAXLINE], m_format[FB_MAXLINE];
         int longflag, endflag, starflag, tmpint;
	 
	 format = va_arg(*pp, char *);
         /*
